...
Repository: https://github.com/ewnike/NHL-Beyond-27.git
Submission commit: a2654c6
Repro: pip install -r src/requirements.txt; open src/notebooks/*; inputs in src/data/
